...
def errorLog(message):
    global error
    error = str(message)
    print('ERROR--@function-'+str(message))
    error
...
def enterInformation(msdNum,schoolYearValue,periodValue, startDateValue, endDateValue, serviceOption ):
    ...
    try:
        ...
        errorLog('servicePeriod')
    try:
        readDate(startDateValue)
    except:
        errorLog('read -startDateValue')
    try:
